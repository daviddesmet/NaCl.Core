namespace NaCl.Core.SimdTests
{
    ...
    public class Salsa20ScalarTests
    {
        ...
        public Salsa20ScalarTests(ITestOutputHelper output) => _output = output;

        [Fact]
        public void HSalsa20ScalarTestVector1()
        {
        ...
        [Fact]
        public void HSalsa20ScalarTestVector2()
        {
            // 8. Example of the long stream, ref: https://cr.yp.to/highspeed/naclcrypto-20090310.pdf
        ...
        [Fact]
        public void HSalsa20ScalarTestVector3()
        {
            // 8. Example of the long stream, ref: https://cr.yp.to/highspeed/naclcrypto-20090310.pdf
        ...
        [Fact]
        public void Salsa20ScalarBlockWhenNonceLengthIsEmptyFails()
        {
            // Arrange
            var key = new byte[Snuffle.KEY_SIZE_IN_BYTES];
            ...
            var core = new Salsa20Core(salsa20);
        ...
        [Fact]
        public void Salsa20ScalarBlockWhenNonceLengthIsInvalidFails()
        {
            // Arrange
            var key = new byte[Snuffle.KEY_SIZE_IN_BYTES];
        ...
        [Fact]
        public void Salsa20ScalarBlockWhenLengthIsInvalidFails()
        {
            // Arrange
            var key = new byte[Snuffle.KEY_SIZE_IN_BYTES];
        ...
        public void Salsa20ScalarProcessTestVectors(Salsa20TestVector test)
        {
            ...
            var core = new Salsa20Core(cipher);
