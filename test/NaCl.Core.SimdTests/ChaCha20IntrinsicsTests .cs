namespace NaCl.Core.SimdTests
{
    ...
    public class ChaCha20IntrinsicsTests
    {
        [Fact]
        public void HChaCha20IntrinsicsTestVectors()
        {
            // Arrange
            foreach (var test in HChaCha20TestVector.HChaCha20TestVectors)
            {
                var xChaCha20 = new XChaCha20(test.Key, 0);
                var cipher = new ChaCha20CoreIntrinsics(xChaCha20);
        ...
        [Fact]
        public void HChaCha20IntrinsicsBlockTestVector()
        {
        ...
        public void IntrinsicsEncryptDecrypt1BlockTest()
        {
            ...
            var cipher = new ChaCha20CoreIntrinsics(chacha20);
        ...
        [Fact]
        public void ChaCha20IntrinsicsBlockWhenNonceLengthIsEmptyFails()
        {
            // Arrange
            var key = new byte[Snuffle.KEY_SIZE_IN_BYTES];

            var chacha20 = new ChaCha20(key, 0);
            var core = new ChaCha20CoreIntrinsics(chacha20);
        ...
        [Fact]
        public void ChaCha20IntrinsicsBlockTestVector()
        {
        ...
        [Fact]
        public void ChaCha20IntrinsicsTestVector()
        {
        ...
        [Fact]
        public void ChaCha20IntrinsicsTestVectorTC8()
        {
