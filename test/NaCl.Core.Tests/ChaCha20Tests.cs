...
public class ChaCha20Tests
{
    ...
    [Fact]
    public void QuarterRoundTestSse3()
    {
        if (!Sse3.IsSupported)
            return;
        ...
        // Arrange
        var v128 = Vector128.Create(0x11111111u, 0x01020304u, 0x9b8d6f43u, 0x01234567u);

        // Act
        ChaCha20Base.QuarterRound(ref v128, ref v128, ref v128, ref v128);

        // Assert
        v128.GetElement(0).Should().Be(0xea2a92f4);
        v128.GetElement(1).Should().Be(0xcb1cf8ce);
        v128.GetElement(2).Should().Be(0x4581472e);
        v128.GetElement(3).Should().Be(0x5881c4bb);
    }

    [Fact]
    public void QuarterRoundTestAxv2()
    {
        if (!Avx2.IsSupported)
            return;
        ...
        // Arrange
        var v256 = Vector256.Create(0x11111111u, 0x01020304u, 0x9b8d6f43u, 0x01234567u, 0x11111111u, 0x01020304u, 0x9b8d6f43u, 0x01234567u);

        // Act
        ChaCha20Base.QuarterRound(ref v256, ref v256, ref v256, ref v256);

        // Assert
        v256.GetElement(0).Should().Be(0xea2a92f4);
        v256.GetElement(1).Should().Be(0xcb1cf8ce);
        v256.GetElement(2).Should().Be(0x4581472e);
        v256.GetElement(3).Should().Be(0x5881c4bb);

        v256.GetElement(4).Should().Be(0xea2a92f4);
        v256.GetElement(5).Should().Be(0xcb1cf8ce);
        v256.GetElement(6).Should().Be(0x4581472e);
        v256.GetElement(7).Should().Be(0x5881c4bb);
    }
    ...
    [InlineData(1023)]
    [InlineData(1024)]
    public void ChaCha20VariableLengthCiphers(int size)
    {
