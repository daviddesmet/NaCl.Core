...
Only the latest release of NaCl.Core published on [NuGet](https://www.nuget.org/packages/NaCl.Core) receives security updates.
...
Report vulnerabilities privately via [GitHub Security Advisories](https://github.com/daviddesmet/NaCl.Core/security/advisories/new).
...
- Nonce generation is the responsibility of the caller. Nonce reuse with the same key breaks the security guarantees of all ciphers in this library; this is inherent to the algorithms and not considered a vulnerability.
